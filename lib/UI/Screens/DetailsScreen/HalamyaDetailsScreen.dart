              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "بالرغم من أن حقوق الإنسان وطبيعية عالمية ومتساوية بغض النظر عن الجنس والأصل واللون والعرق والدين، إلا أن العقبات التي تواجه النساء لا تزال تحول دون تحقيق المساواة بين الجنسين. ورغم أن القوانني لا متنع النساء من المشاركة في الحياة السياسية والترشّ ح، غري أن ٍ ضعف التمثيل السياسي يرتبط بشكل أساسي بالواقع متعددة تحول دون ّ الذي يعز ٍ ز الصورة النمطية وبعوامل ّ ّ مشاركة سياسية نسائية فعالة وحقيقية." +
                          "\n   \n" +
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          "إنعكس تطور حقوق النساء في العديد من المواثيق والاتفاقيات والإعلانات الدولية، والمؤمترات، وهيئات الأمم المتحدة ّ والمنظامت. وتطورت هذه الحقوق بدءاً من مفهوم المساواة بين الجنسين إلى مفهوم إلغاء التمييز ضد النساء والفتيات وصولاً ّط على النساء، ومن لمناهضة العنف المُسل ثم دورها في صنع القرار والمشاركة السياسية وبناء عمليتي الأمن والسلام، وصولاً إلى تحقيق أهداف التنمية المستدامة.",
                          style: theme(context)
                              .textTheme
                              .headline2!
