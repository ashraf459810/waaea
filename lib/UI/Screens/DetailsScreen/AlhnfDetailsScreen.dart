              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "العنف هـو “اعتداء جسـدي أو معنوي مقصود مـن جهة تتمتع بسلطة مادية أو معنوية على جهة أخرى. وقد تكون هـذه الجهة فـرداً أو جامعة أو طبقة اجتماعية أو دولة تحاول إخضاع جهة أخرى في إطار علاقة قوة غري ّب متكافئة إجتامعياً وسياسياً وإقتصادياً، ما قـد يتسـب فـي إحداث أضرار مادية أو معنوية أو نفسية على فـرد أو جامعة أو طبقة اجتامعية أو دولة أخرى ”",
                      style: theme(context)
                          .textTheme
                          .bodyText1!
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 30, vertical: 10),
                    child: Text(
                      "الأعراف والتقاليد الاجتماعية والقبلية، والخوف من وصمة العار، وتصاعد العنف ( لاسيام القتل بداعي الشرف) تحول دون قيام النساء والفتيات بالابلاغ عام يتعرضن له من انتهاكات، في ظل ضعف إنفاذ القانون. حيث تتجه القضايا للحل عن طريق الجلسات العشائرية والمفاوضات الاسرية دون اعتبار لحقوق الضحايا." +
                          "\n   \n",
                      style: theme(context)
                          .textTheme
                          .bodyText1!
