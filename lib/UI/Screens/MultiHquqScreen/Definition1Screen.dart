...
//                   child: Text(
//                     Constants.definitionModel.title,
//                     style: theme(context)
//                         .textTheme
//                         .headline5!
...
//                   height: 6,
//                 ),
//                 Constants.definitionModel.subTitle != "null"
//                     ? Text(
//                         Constants.definitionModel.subTitle,
//                         style: theme(context)
//                             .textTheme
//                             .headline5!
...
//                 ),
//                 Constants.definitionModel.extra != "null"
//                     ? Text(
...
//     List<Widget> list = [];
//     for (int i = 0; i < Constants.definitionModel.defineList.length; i++) {
//       list.add(quoteCard(
//           context: context,
//           label: Constants.definitionModel.labelList[i],
//           define: Constants.definitionModel.defineList[i]));
//     }
//     return list;
//   }
// }
