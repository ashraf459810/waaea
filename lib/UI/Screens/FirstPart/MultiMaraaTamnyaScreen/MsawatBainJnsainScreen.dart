              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "قد تتعرض المكاسب المحدودة على صعيد المساواة بين الجنسين وحقوق المرأة التي تحققت على مدى عقود معرضة لخطر التراجع بسبب جائحة كوفيد، لذلك قد وضعت هيئة الأمم المتحدة للمرأة استجابة سريعة وموجهة للتخفيف من تأثري أزمة كوفيد-19 على النساء والفتيات وضامن أن الإنعاش طويل الأجل ٍ سيكون ذو فائدة لهن، مع التركيز على خمس أولويات:قد تتعرض المكاسب المحدودة على صعيد المساواة بين الجنسين وحقوق المرأة التي تحققت على مدى عقود معرضة لخطر التراجع بسبب جائحة كوفيد، لذلك قد وضعت هيئة الأمم المتحدة للمرأة استجابة سريعة وموجهة للتخفيف من تأثري أزمة كوفيد-19 على النساء والفتيات وضامن أن الإنعاش طويل الأجل ٍ سيكون ذو فائدة لهن، مع التركيز على خمس أولويات:",
                      style: theme(context).textTheme.subtitle1!.copyWith(
                            color: Colors.black87,
                            fontSize: 20,
                          ),
