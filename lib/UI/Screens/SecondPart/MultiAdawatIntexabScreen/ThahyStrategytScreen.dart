            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "تحتاج الاستراتيجية لتنفيذها إلى عدد من المهارات التنظيمية: هي ليست عمل عشوايئ بل تعتمد تحتاج الى التخطيط السليم الذي يعتمد بشكل أساسي على دقة البيانات وعلى تحديد الاحتياجات والأولويات لكل فئة اجتامعية بالإضافة إلى خصائصها والثقافية والسياسية والاقتصادية والاجتامعية",
                      style: theme(context).textTheme.headline5!.copyWith(
                            color: Colors.black87,
                            fontSize: 20,
                          ),
